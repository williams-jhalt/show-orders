...
//                }
//
//                $salesPerson = $em->getRepository('AppBundle:SalesPerson')->findOneBySalesPersonNumber($salesPersonNumber);
//
//                if ($salesPerson === null) {
//                    $salesPerson = new SalesPerson();
//                    $salesPerson->setSalesPersonNumber($salesPersonNumber);
//                    $salesPerson->setName($salesPersonNumber);
//                    $em->persist($salesPerson);
//                    $em->flush($salesPerson);
//                }
//
